...
saveRDS(users_daily_small, file = "data-small/sj_users_daily_small.rds")
saveRDS(all_revenue_small, file = "data-small/sj_all_revenue_small.rds")
saveRDS(all_sessions_small, file = "data-small/sj_all_sessions_small.rds")
saveRDS(user_summary_small, file = "data-small/sj_user_summary_small.rds")
